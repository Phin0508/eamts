...
// Build query - ONLY show tickets where this manager is the REQUESTER
...
// Get statistics for manager's own tickets only
$stats_query = "
    SELECT 
        COUNT(*) as total,
...
<body>
        ...
        <div class="dashboard-content">
            <header class="page-header">
                <div class="header-left">
                    <h1>My Tickets</h1>
                    <p>View and manage your personal support tickets</p>
                </div>
                <div class="header-right">
                    <a href="managerCreateTicket.php" class="btn btn-primary">
            ...
            <div class="filters-section">
                <form method="GET" action="" class="filters-form">
                    ...
                    <a href="managerTicket.php" class="btn btn-outline">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="9" class="no-data">
                                    ...
                                    <a href="managerCreateTicket.php" class="btn btn-primary">Create Your First Ticket</a>
                                </td>
                            </tr>
                            <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="managerticketDetails.php?id=<?php echo $ticket['ticket_id']; ?>" class="btn-icon" title="View Details">
            ...
            <div class="content-card" style="margin-top: 2rem;">
                ...
                <p>If you have any questions about your tickets or need assistance, please contact IT support or your administrator.</p>
                <div style="margin-top: 1rem;">
                    <a href="managerCreateTicket.php" class="btn btn-primary">
                        <i class="fas fa-plus"></i> Create New Ticket
                    </a>
                    <a href="../users/managerDashboard.php" class="btn btn-outline">
    ...
    <script>
        // Show success message if redirected after ticket creation
        <?php if (isset($_SESSION['ticket_created'])): ?>
            const successAlert = document.createElement('div');
            successAlert.style.cssText = 'position: fixed; top: 20px; right: 20px; background: linear-gradient(135deg, #10b981, #059669); color: white; padding: 1.25rem 1.5rem; border-radius: 12px; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3); z-index: 9999; animation: slideIn 0.3s ease;';
            successAlert.innerHTML = '<div style="display: flex; align-items: center; gap: 0.75rem;"><i class="fas fa-check-circle" style="font-size: 1.5rem;"></i><div><strong style="display: block; margin-bottom: 0.25rem;">Ticket Created Successfully!</strong><span style="font-size: 0.875rem; opacity: 0.9;">Your ticket has been auto-approved and submitted.</span></div></div>';
            ...
            <?php unset($_SESSION['ticket_created']); ?>
        <?php endif; ?>
    </script>
</body>
</html>