...
if ($asset_id === 0) {
    header("Location: departmentAsset.php");
    exit();
}

// Fetch asset details - only from manager's department
$asset = null;
try {
    $query = "SELECT a.*, 
              ...
              WHERE a.id = ? AND a.department = ?";
    $stmt = $pdo->prepare($query);
    $stmt->execute([$asset_id, $manager_dept]);
    $asset = $stmt->fetch(PDO::FETCH_ASSOC);

    if (!$asset) {
        $_SESSION['error_message'] = "Asset not found or access denied.";
        header("Location: departmentAsset.php");
        exit();
    }
...
// Check for upcoming maintenance (within notify period)
    ...
    <div class="main-content">
        <div class="details-container">
            ...
            <div class="breadcrumb">
                <a href="departmentAsset.php">← Back to Department Assets</a>
            </div>
            ...
            <div class="read-only-notice">
                ...
                <div>
                    <strong>Manager View Only:</strong> You can view all asset details and maintenance information. To add maintenance records or schedules, please contact IT administrators.
                </div>
            </div>
            ...
            <div class="tab-content active" id="maintenance-tab">
                <div class="section-card">
                    <div class="section-header">
                        <h2>🔧 Maintenance History (<?php echo count($maintenance_records); ?> Records)</h2>
                        <div class="cost-display" style="font-size: 18px;">
                            Total Cost: $<?php echo number_format($total_maintenance_cost, 2); ?>
                        </div>
                    </div>
                        ...
                        <table class="maintenance-table">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td colspan="3" class="cost-display">$<?php echo number_format($total_maintenance_cost, 2); ?></td>
                                </tr>
                            </tfoot>
                        </table>
                    <?php else: ?>
            ...
            <div class="tab-content" id="recurring-tab">
                <div class="section-card">
                    <div class="section-header">
                        <h2>🔄 Recurring Maintenance Schedules (<?php echo count($recurring_schedules); ?>)</h2>
                    </div>
                            ...
                            <div class="recurring-card <?php echo $card_class; ?>">
                                    ...
                                    <div>
                                        <div class="recurring-title">
                                            ...
                                            <?php if (!$schedule['is_active']): ?>
                                                <span style="color: #dc3545; font-size: 14px;"> (INACTIVE)</span>
                                            <?php endif; ?>
                                        </div>
                                ...
                                <div class="recurring-info">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value"><?php echo date('M d, Y', strtotime($schedule['start_date'])); ?></div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-label">Notify Before</div>
                                        <div class="info-value"><?php echo $schedule['notify_days_before']; ?> days</div>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
